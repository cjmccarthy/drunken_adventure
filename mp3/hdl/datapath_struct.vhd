...
ARCHITECTURE struct OF DATAPATH IS
   ...
   SIGNAL EXECUTE_CONTROL_WORD_IN  : STD_LOGIC_VECTOR(15 DOWNTO 0);
   SIGNAL EXECUTE_CONTROL_WORD_OUT : lc3b_word;
   ...
   SIGNAL MEM_CONTROL_WORD_IN      : STD_LOGIC_VECTOR(15 DOWNTO 0);
   SIGNAL MEM_CONTROL_WORD_OUT     : lc3b_word;
   ...
   SIGNAL SRMUX_OUT                : LC3B_REG;
   SIGNAL WB_ALU_IN                : LC3B_WORD;
   SIGNAL WB_CONTROL_WORD_IN       : LC3B_WORD;
   ...
   PORT (
      ...
      EXECUTE_CONTROL_WORD_IN : OUT    STD_LOGIC_VECTOR (15 DOWNTO 0);
